...
public class PublicProcess {
    ...
    // "http://my.anjuke.com/my/login?history=aHR0cDovL3NoYW5naGFpLmFuanVrZS5jb20v";
     ...
     * 返回随机的一个城市
     * <p/>
     * cityType: 1 有爱房且倾向二手房的城市 2 有爱房且倾向新房的城市 3 非以上且非第6大区城市 4 第6大区城市 123
     * Type为1、2、3城市的总和
     *
     ...
     * @param cityType   1 有爱房且倾向二手房的城市 2 有爱房且倾向新房的城市 3 非以上且非第6大区城市 4 第6大区城市 123
     *                   Type为1、2、3城市的总和
     * @return “shanghai-上海”
     */
    ...
    public String dologin(Browser driver, String name, String pass) {
        ...
        return driver.getText(Public_HeaderFooter.HEADER_UserName, "获取用户名", 10);
    }
    ...
    public void uploadPicMulti(Browser driver, String type) {
        ...
        if (type.equals("sale")) {
            ...
            try {
                Thread.sleep(2000);
                Runtime.getRuntime().exec(new TcTools().getProjectPath() + "uploadShinei.exe").waitFor();
                Thread.sleep(3000);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            // picMess = "上传室内图";
            // driver.uploadFile(Broker_PropertynewRentStep.SHINEITU,
            // TcTools.imgPath("600x600.jpg"), picMess);
        }
        exception(driver, picMess, picCount);
        // 上传房型图片
        if (type.equals("sale")) {
            ...
            try {
                Thread.sleep(2000);
                Runtime.getRuntime().exec(new TcTools().getProjectPath() + "uploadHuxing.exe").waitFor();
                Thread.sleep(3000);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            // picMess = "上传房型图";
            // driver.uploadFile(Broker_PropertynewRentStep.FANGXINGTU,
            // TcTools.imgPath("800x800.jpg"), picMess);
        }
        exception(driver, picMess, picCount);
        // 上传小区图片
        if (type.equals("sale")) {
            ...
            try {
                Thread.sleep(2000);
                Runtime.getRuntime().exec(new TcTools().getProjectPath() + "uploadXiaoqu.exe").waitFor();
                Thread.sleep(3000);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            // picMess = "上传小区图";
            // driver.uploadFile(Broker_PropertynewRentStep.XIAOQUTU,
            // TcTools.imgPath("600x600x0.jpg"), picMess);
        }
        exception(driver, picMess, picCount);
    ...
    public void uploadPicMix(Browser driver, String type) {
        ...
        if (type.equals("sale")) {
            ...
            // System.out.println("ccav:"+TcTools.imgPath("600x600.jpg"));
            driver.uploadFile(Broker_PropertynewSaleStep.SHINEISINGLE, TcTools.imgPath("800x800.jpg"), picMess, 30);
        } else {
            picMess = "上传室内图";
            driver.uploadFile(Broker_PropertynewRentStep.SHINEITU, TcTools.imgPath("600x600.jpg"), picMess);
        }
