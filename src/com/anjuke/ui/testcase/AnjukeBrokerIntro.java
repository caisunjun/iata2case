...
/**
 * @Todo 店铺管理-个人介绍-自我介绍 更改卖房宣言和详细介绍（固定内容+随机生成的内容） 进入个人店铺，验证卖房宣言和详细介绍是否和输入的值一致
 * @author fjzhang
 * @since 2012-11-13
...
public class AnjukeBrokerIntro {
	...
	public void testBrokerIntroduce() {
		...
		String selfintro = "性格活泼开朗的我，刚进大学那会就和房产结下了不解之缘。"
				...
				+ "看售楼大姐向客户做下介绍，带客户看下户型、样板房，很快就签定合同。" + "测试 侧his"
		...
		bs.switchWindo(2);
		String actualslogan = bs.findElement(Ajk_ShopView.SLOGAN, "获得卖房宣言文本",
				60).getText();
		String actualselfintro = bs.findElement(Ajk_ShopView.SELFINTRO,
				"获取自我介绍文本", 60).getText();
